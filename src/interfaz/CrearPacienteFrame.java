    ...
    public void initialize(){
        ...
        btnOK.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (Nombres.isEmpty() || Apellidos.isEmpty() || Edad.isEmpty() || Password.length() == 0 || Genero.equals("Selecciona uno")) {
                ...
                JOptionPane.showMessageDialog(null, "Paciente creado con éxito, código: " + codigoString, "Usuario creado", JOptionPane.INFORMATION_MESSAGE);
                Usuario nuevoUsuario = new Usuario(codigoString, Password, Nombres, Apellidos, Genero, Edad);
